...
public class BPAQueryBuilder {
	...
	private static final String QUERY = "SELECT bpa.*,bpaplotinfo.*,bpabuildinginfo.*,bpafloorinfo.*,bpadoc.*,bpa.id as bpa_id,bpa.tenantid as bpa_tenantId,bpa.lastModifiedTime as "
